                ...
                <tr>
                   ...
                   <?php 
                    ...
                    <td>
                        <?php 
                            if($d['StatusPeminjaman'] == 'wait'){ ?>
                                <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#konfirmasi<?= $d['PeminjamanID'] ?>"><i class="fa fa-check"></i></button>
                                <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#pengembalian<?= $d['PeminjamanID'] ?>" disabled>kembalikan</button>
                         <?php   } elseif($d['StatusPeminjaman'] == 'pinjam'){ ?>
                            <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#konfirmasi<?= $d['PeminjamanID'] ?>" disabled><i class="fa fa-check"></i></button>
                                <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#pengembalian<?= $d['PeminjamanID'] ?>"><i class="fa fa-bookarrowright">kembalikan</i></button>
                      <?php   } else { ?>
                        <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#konfirmasi<?= $d['PeminjamanID'] ?>" disabled><i class="fa fa-check"></i></button>
                                <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#pengembalian<?= $d['PeminjamanID'] ?>" disabled><i class="fa fa-bookarrowright">kembalikan</i></button>
                    <?php  }
                        ?>
                    
                  <a class="btn btn-danger btn-sm" href="dashboard.php?page=hapuspeminjaman&PeminjamanID=<?= $d['PeminjamanID'] ?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')"><i class="fa fa-trash"></i></a>
              </td>
                </tr>
             <?php   }
            ?>
